    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for($i = 1; $i <= 10; $i++)
        {
            ...
            $article->setTitre("Titre de l'article $i")
                    ->setContenu("<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque pariatur ab maxime culpa ea nesciunt aspernatur reprehenderit officiis repudiandae sint.</p>")
            ...
            // persist() : méthode issu de la classe ObjectManaget (ORM Doctrine) permettant de garder en mémoire les 10 objets $articles et de préparer les requetes SQL         
